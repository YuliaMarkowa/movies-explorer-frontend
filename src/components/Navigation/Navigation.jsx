      ...
      <nav className="navigation-modal__main">
        <ul className="navigation-modal__links">
          <li className="navigation-modal__item">
            <Link to="/" className="navigation-modal__link" onClick={onClose}>
              Главная
            </Link>
          </li>
          <li className="navigation-modal__item" onClick={onClose}>
        ...
        <Link to="/profile" className="navigation-modal__link-account" onClick={onClose}>
          Аккаунт
          <img
            src={user}
